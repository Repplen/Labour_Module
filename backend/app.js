...
const mainLocationRoutes = require("./routes/mainLocation.routes");
const equipmentRoutes = require("./routes/equipment.routes");
const labourPieceWorkerRoutes = require("./routes/labourPieceWorker.routes");
const labourTeamRoutes = require("./routes/labourTeam.routes");
const pieceWorkerTeamRoutes = require("./routes/pieceWorkerTeam.routes");
const natureOfWorkRoutes = require("./routes/natureOfWork.routes");
...
const createApp = () => {
  ...
  app.use("/api/main-locations", moduleEnabled("main_location"), mainLocationRoutes);
  app.use("/api/equipment", moduleEnabled("equipment_master"), equipmentRoutes);
  app.use("/api/labour-piece-workers", moduleEnabled("labour_piece_worker_master"), labourPieceWorkerRoutes);
  app.use("/api/labour-teams", moduleEnabled("labour_team_master"), labourTeamRoutes);
  app.use("/api/piece-worker-teams", moduleEnabled("piece_worker_team_master"), pieceWorkerTeamRoutes);
  app.use("/api/uom", moduleEnabled("uom"), uomRoutes);
  app.use("/api/nature-of-work", moduleEnabled("nature_of_work"), natureOfWorkRoutes);
